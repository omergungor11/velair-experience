...
| VEL-01 | 1 | Kadraj, font, malzeme ve bölüm tasarımı | Creative | VEL-00 | 3 ana kadraj + mobil yerleşim + asset briefi | Hazır |
| VEL-02 | 1 | Model edinim/üretim ve cutaway prova | Scene | VEL-00 | Lisans, node/eksen, iç geometri ve boyut doğrulanır | Hazır |
...
| VEL-05 | 2 | Saf pose sampler ve scroll timeline | Motion | VEL-00 | Deterministik poz; sınır/ters/jump testleri | Hazır |
